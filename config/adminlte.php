    ...
    */
    ...
    'menu' => [
        ...
        [
            ...
            'icon'        => 'nav-icon far fa-fw fa-user',
            'is_admin' => "1"
        ],
        // for service provider
        [
            'text'        => 'Dashboard',
            'route'         => 'serviceProvider.home',
            'icon'        => 'nav-icon fas fa-th',
            'is_admin' => "0"
        ],
        [
        ...
        'Summernote' => [
            ...
            'files' => [
                [
                    'type' => 'css',
                    'asset' => true,
                    'location' => 'assets/plugins/summernote/summernote-bs4.min.css',
                ],
                [
                    'type' => 'js',
                    'asset' => true,
                    'location' => 'assets/plugins/summernote/summernote-bs4.min.js',
                ],
            ],
        ],
        'Sweetalert2' => [
